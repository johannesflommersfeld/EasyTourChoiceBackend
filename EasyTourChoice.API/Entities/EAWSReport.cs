...
namespace EasyTourChoice.API.Entities
{
    ...
    public record EAWSBulletin
    {
        ...
        required public ValidTime ValidTime { get; set; }
        ...
        required public AvalancheActivity AvalancheActivity { get; set; }

        [JsonProperty("snowpackStructure", Required = Required.Always)]
        required public SnowpackStructure SnowpackStructure { get; set; }
        ...
        required public TravelAdvisory TravelAdvisory { get; set; }
    ...
    public record AvalancheActivity
    {
    ...
    public record SnowpackStructure
    {
        [JsonProperty("highlights", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
    ...
    public record Tendency
    {
        ...
        required public ValidTime? ValidTime { get; set; } = null;
    }
